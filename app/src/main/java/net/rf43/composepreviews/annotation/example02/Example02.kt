package net.rf43.composepreviews.annotation.example02

import androidx.compose.material3.Surface
import androidx.compose.runtime.Composable
import net.rf43.composepreviews.CardComposable
import net.rf43.composepreviews.CardConfig
import net.rf43.composepreviews.annotation.FontSizePreview
...
/*
 * Implementing two custom annotations to create previews of the `CardComposable` composable.
 */

@UiModeThemePreview
@Composable
private fun Preview01() {
